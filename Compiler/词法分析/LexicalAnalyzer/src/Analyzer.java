...
public class Analyzer {
	...
	public char readin() {              //���������ȡ��list1�ĵ�һ���ַ�����list2��ĩβ
		char a1 = list1.pollFirst();
		list2.offerLast(a1);
		return a1;
	}

	public void readout() {            //����������ȡ��list2�����һ���ַ��Ż�list1
		char a2 = list2.pollLast();
		list1.offerFirst(a2);
	}

	public String getFromList2() {       //��ȥlist2��������Թ����
	...
	public void analysis() throws IOException {
		...
		while (!list1.isEmpty()) {
			...
			case 2: // ��ʶ����ؼ�������
				...
				if (IDType.isKeywords(string.trim())) { // ������ڹؼ��ֱ����ҵ������ǹؼ�������
