...
final class ActionsFileTests {
  ...
  void testBasicActionsFileIsReadable() {
      try {
          ...
          Element firstAction = (Element)actions.item(7);
          Element triggers = (Element)firstAction.getElementsByTagName("produced").item(0);
          System.out.println(firstAction.getElementsByTagName("produced").getLength());
          // Get the first trigger phrase
          String firstTriggerPhrase = triggers.getElementsByTagName("entity").item(0).getTextContent();
          System.out.println(triggers.getElementsByTagName("entity").getLength());
